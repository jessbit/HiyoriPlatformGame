...
public class Collectable:MonoBehaviour
{
    ...
    public bool collectOnContact = true;//是否立马收集
    public int times = 1;//可收集次数
    public float ghostingDuration = 0.5f; //刚生成时不可收集
    ...
    protected virtual IEnumerator CollectRoutine(Player player)
    {
        for (int i = 0; i < times; i++)
        {
            ...
            yield return new WaitForSeconds(0.1f);//防止音效重叠
        }
    }

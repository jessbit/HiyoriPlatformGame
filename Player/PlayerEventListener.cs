...
[AddComponentMenu("Game/Player/Player Event Listener")]
public class PlayerEventListener :MonoBehaviour
{
    ...
    protected virtual void InitializeCallbacks()
    {
        ...
        player.playerEvents.OnStompEnding.AddListener( call:()=> events.OnStompEnding.Invoke());
        player.playerEvents.OnLedgeGrabbed.AddListener( call: ()=> events.OnLedgeGrabbed.Invoke());
        player.playerEvents.OnLedgeClimbing.AddListener( call: ()=> events.OnLedgeClimbing.Invoke());
